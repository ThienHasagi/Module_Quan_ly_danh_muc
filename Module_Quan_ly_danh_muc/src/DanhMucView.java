...
public class DanhMucView extends JFrame {
    ...
    private void initTabHangHoa() {
        ...
        formPanel.add(new JLabel("  Mã hàng hóa (*):")); txtMaHH = new JTextField(); formPanel.add(txtMaHH);
        formPanel.add(new JLabel("  Tên hàng hóa (*):")); txtTenHH = new JTextField(); formPanel.add(txtTenHH);
        formPanel.add(new JLabel("  Mô tả:")); txtMoTaHH = new JTextField(); formPanel.add(txtMoTaHH);
        formPanel.add(new JLabel("  Số lượng tồn:")); JTextField txtTon = new JTextField("Tự động (Mặc định = 0)"); txtTon.setEditable(false); formPanel.add(txtTon); // Khóa quyền nhập thủ công [cite: 22, 67]
        ...
        actionPanel.add(new JLabel("Từ khóa:")); actionPanel.add(txtSearchHH);
        actionPanel.add(btnSearch); actionPanel.add(Box.createHorizontalStrut(30));
        actionPanel.add(btnAdd); actionPanel.add(btnEdit); actionPanel.add(btnDelete); actionPanel.add(btnClear);
    ...
    private void initTabNhaCungCap() {
        ...
        formPanel.add(new JLabel("  Mã NCC (*):")); txtMaNCC = new JTextField(); formPanel.add(txtMaNCC);
        formPanel.add(new JLabel("  Tên nhà cung cấp (*):")); txtTenNCC = new JTextField(); formPanel.add(txtTenNCC);
        formPanel.add(new JLabel("  Địa chỉ trụ sở:")); txtDiaChiNCC = new JTextField(); formPanel.add(txtDiaChiNCC);
        formPanel.add(new JLabel("  Số điện thoại (*):")); txtSdtNCC = new JTextField(); formPanel.add(txtSdtNCC);
        ...
        actionPanel.add(new JLabel("Từ khóa:")); actionPanel.add(txtSearchNCC); actionPanel.add(btnSearch);
    ...
    private void loadDataNCC(String tuKhoa) {
        ...
        try {
            ...
            for (NhaCungCap ncc : list) {
                modelNCC.addRow(new Object[]{ncc.getId(), ncc.getMaNCC(), ncc.getTenNCC(), ncc.getDiaChi(), ncc.getSoDienThoai()});
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void clearFormNCC() {
        selectedIdNCC = -1;
        txtMaNCC.setText(""); txtMaNCC.setEditable(true);
        txtTenNCC.setText(""); txtDiaChiNCC.setText(""); txtSdtNCC.setText("");
    ...
    private void initTabDaiLyCon() {
        ...
        formPanel.add(new JLabel("  Mã Đại lý (*):")); txtMaDL = new JTextField(); formPanel.add(txtMaDL);
        formPanel.add(new JLabel("  Tên đại lý con (*):")); txtTenDL = new JTextField(); formPanel.add(txtTenDL);
        formPanel.add(new JLabel("  Địa chỉ giao nhận:")); txtDiaChiDL = new JTextField(); formPanel.add(txtDiaChiDL);
        formPanel.add(new JLabel("  Số điện thoại (*):")); txtSdtDL = new JTextField(); formPanel.add(txtSdtDL);
        ...
        actionPanel.add(new JLabel("Từ khóa:")); actionPanel.add(txtSearchDL); actionPanel.add(btnSearch);
        actionPanel.add(Box.createHorizontalStrut(30));
        actionPanel.add(btnAdd); actionPanel.add(btnEdit); actionPanel.add(btnDelete); actionPanel.add(btnClear);
    ...
    private void loadDataDaiLy(String tuKhoa) {
        ...
        try {
            ...
            for (DaiLyCon dl : list) {
                modelDL.addRow(new Object[]{dl.getId(), dl.getMaDL(), dl.getTenDL(), dl.getDiaChi(), dl.getSoDienThoai()});
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void clearFormDL() {
        selectedIdDL = -1;
        txtMaDL.setText(""); txtMaDL.setEditable(true);
        txtTenDL.setText(""); txtDiaChiDL.setText(""); txtSdtDL.setText("");
        tableDL.clearSelection();
    }

    // ================= THÀNH PHẦN KHỞI CHẠY (MAIN) =================
    public static void main(String[] args) {
        try {
            // Đặt giao diện hiển thị theo chuẩn hệ điều hành (Look and Feel)
